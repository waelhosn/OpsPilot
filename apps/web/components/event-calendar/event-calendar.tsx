...
export function EventCalendar({
  ...
  return (
    <>
      {showInternalDialogs ? <EventDialog /> : null}
      {showInternalDialogs ? <MonthDayEventsDialog /> : null}
      {showInternalDialogs ? <EventCreateDialog /> : null}
      <div className="bg-background overflow-hidden rounded-xl border shadow-sm">
        <CalendarToolbar events={events} toolbarActions={toolbarActions} />
